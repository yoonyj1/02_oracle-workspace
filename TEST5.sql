...
INSERT INTO TB_SAUCE_INGRE
VALUES('SI' || SEQ_SI_NO.NEXTVAL, 'S' || SEQ_SAUCE_NO.CURRVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, '약간');
...
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '닭다리살은 1개당 4~5등분으로 자르고 밑간 재료에 20분 정도 재워주세요.');
...
INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '대파는 3센치 길이로 썰어주세요. 볼에 양념 재료를 넣고 섞어주세요.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/01/04/ecf1eec4a22cddfa5431781e68f160d51.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '닭고기와 대파를 꼬치에 번갈아 가며 끼운 후 양념을 발라주세요.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/01/04/3c4287eb7ec9dd421dc4833ed816b60f1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '구이 전용 팬에 닭 꼬치를 올린 후 4단에 넣고 광파오븐 자동 요리 <구이>에서 <닭 꼬치>를 선택한 후 500g을 선택해 구워주세요. 도중에 멜로디가 울리면 한번 뒤집어 주세요.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/01/04/2e6da04b035e5534c5921fdb5a182e9d1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '완성된 닭 꼬치에 송송 썬 쪽파를 뿌려  맛있게 즐겨주세요.');
...
-- 2번 게시글 요리순서 & 요리순서이미지
INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '만두는 기름을 두룬 팬에 노릇하게 구워줍니다.	');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/09/28/8fc533297f2fc246cbbf5f2fd1c8dfc21.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '비엔나 소세지에 원하는 모양대로 칼집을 내고 팬에 볶아줍니다. 양파가 있다면 같이 볶아줘도 좋아요:)');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/09/28/199b0d79568471660afcb5a4ac07b3171.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '비엔나가 어느정도 구워지면 만두를 같이 넣어줍니다.	');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/09/28/04feae556dcd5899ef67ffb89e051fb51.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '양념장을 넣고 양념이 고루 베이도록 잘 섞어줍니다');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/09/28/05e4e16467b13cc29ffa7c1d07e8cc911.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '양념이 어느정도 베이면 위에 통깨를 뿌려 마무리합니다.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/09/28/61da0ef87e2a754dc739eb177c3395341.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '간식이나 술안주, 밑반찬으로 먹기 좋은 비엔나만두강정 완성!');
...
-- 4번 게시글 요리순서 & 요리순서이미지
INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '쇠고기는 칼끝으로 힘줄을 끊어주고 새송이버섯, 파프리카, 양파는 먹기 좋은 크기로 썰어둔다.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2023/02/03/d9173b2113b4528c037d0d2fe5a044901.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '식용유를 두르고 썰어둔 채소를 넣고 허브솔트로 간을 한 후 노릇하게 구워준다.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2023/02/03/45af706b00b803598c45d77c2b0bc3411.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '고기에 올리브유, 허브솔트를 뿌려둔다.	');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2023/02/03/a5c5b37a1bb79f459fe7da2ad527f0371.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '프라이팬에 올려 구워준다.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2023/02/03/17fd748c1956b89f43805af4729431ec1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '구워둔 채소와 스테이크를 담아준다.');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2023/02/03/0fe662825ef57c4378b325672e9ab8c41.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '딸기, 미나리를 올려 마무리한다.');
...
-- 5번 게시글 요리순서 & 요리순서이미지
INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '(6개 기준입니다)소고기는 얇게썬 불고기용으로 6장 준비 해주시구요~고기가 녹으면 키친타올로 살짝살짝 핏물을 닦아 주셔요~고기 하나당 후추,소금 한번씩만 톡 해서 살짝만 밑간을 해주세요');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/cb8d0d829b947d0daa7b192cdb636aa01.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '파프리카 색깔별로 1/3쪽씩 채썰어 주시구요 깻잎6장 씻어서 준비해주세요');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/f090c38a1365f29c57f0f7787034ac0b1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '해동된 소고기는 밑에 깔고 깻잎올려 파프리카를 색깔별로 올려');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/f9fe79fd49ba77487f8093ba7ba310271.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '깻잎부터 돌돌말고 소고기를 말아 주세요~');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/c93329adb20c910d1254e9235a608abb1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '말아진 부분이 풀리지 않게 밑으로 가게끔 두시구요');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/13ecd786640db87799fc57d74888235c1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '구우실때도 풀리지않게 말아진 끝부분 부터 구워 주세요~');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/5791c838196f0bb18ef68a1ee0d68eb11.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '식용유 살짝 둘러 약불로 고기만 익으면 끝이에요^~^');

INSERT INTO TB_COOKING_ORDER_IMG
VALUES('CO' || SEQ_CO_NO.CURRVAL, 'https://recipe1.ezmember.co.kr/cache/recipe/2017/04/24/7fdfbb0846d45c1a994fd67a3d73f2ed1.jpg');

INSERT INTO TB_COOKING_ORDER
VALUES('CO' || SEQ_CO_NO.NEXTVAL, 'R' || SEQ_RECIPE_NO.CURRVAL, 'CO' || SEQ_CO.NO.CURRVAL, '구워진 소고기말이는 어슷썰어 주시면 완성입니다^~^');
