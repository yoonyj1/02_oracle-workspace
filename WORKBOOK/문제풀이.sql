...
WHERE S.DEPARTMENT_NO = D.DEPARTMENT_NO AND S.DEPARTMENT_NO = P.DEPARTMENT_NO AND D.DEPARTMENT_NO = P.DEPARTMENT_NO AND
STUDENT_NO = 'A313047' AND S.COACH_PROFESSOR_NO = P.PROFESSOR_NO;
